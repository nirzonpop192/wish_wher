export const premium12 = ({ img, name, msg, type }) => {
  return `
  ...
  * {
  ...
  .card {
    ...
    box-sizing: border-box;
    background-image: url('https://wishwisher.com/cardeffects/premium-card14effact.png?cache=false');
  ...
  <body>
    <div class="container">
      ...
      <div class="card white">
          ...
          <!-- shape_image -->
          <img src="https://wishwisher.com/cardeffects/premium-card14thirdeffact.png?cache=fals" class="shape_image">
          <!-- secshape_image -->
