export const free5 = ({ img, name, msg, type }) => {
  return `
...
<body>
  ...
  <p class="happy_text hblack">${type}</p>
  <!-- celebrant image html -->
  <img src="${img}" alt="" class="profile_image">
  <!-- effact image html -->
  <img src="https://wishwisher.com/cardeffects/card5effact.png" alt="" class="effact">
  <!-- celebrant name html -->
  <p class="name nblack">${name}</p>
  <!-- bottom line html -->
  <p class="bottom_txt bblack">${msg}</p>
</div>
  </div>
</body>
